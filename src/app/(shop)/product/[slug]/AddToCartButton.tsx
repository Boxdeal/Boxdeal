      ...
      <div className="space-y-3">
        ...
        {!outOfStock && (
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-500 py-3.5 text-sm font-bold text-white transition-all hover:bg-brand-600 active:scale-95"
          >
